...
class LinearSuper(nn.Linear):
    def __init__(self, super_in_dim, super_out_dim, bias=None, uniform_=None, non_linear='linear', scale=False):
        ...
        self.scale = scale
        self._reset_parameters(uniform_, non_linear)
    ...
    def _reset_parameters(self,  uniform_, non_linear):
...
def sample_bias(bias, sample_out_dim):
    sample_bias = bias.data[:sample_out_dim].clone()
